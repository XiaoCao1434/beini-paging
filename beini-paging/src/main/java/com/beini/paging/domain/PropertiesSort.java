...
public class PropertiesSort implements Iterable<com.beini.paging.domain.PropertiesSort.Order>, Serializable {
	...
	public PropertiesSort(Order... orders) {
		this(Arrays.asList(orders));
	}

	public PropertiesSort(List<Order> orders) {
	...
	public PropertiesSort(String... properties) {
		this(DEFAULT_DIRECTION, properties);
	}

	public PropertiesSort(Direction direction, String... properties) {
		this(direction, properties == null ? new ArrayList<String>() : Arrays.asList(properties));
	}

	public PropertiesSort(Direction direction, List<String> properties) {
	...
	public PropertiesSort and(PropertiesSort sort) {
		...
		return new PropertiesSort(these);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PropertiesSort)) {
			return false;
		}

		PropertiesSort that = (PropertiesSort) obj;
	...
	public static class Order implements Serializable {
		 ...
		 *            must not be {@literal null} or empty.
		 * @param ignoreCase
		 *            true if sorting should be case insensitive. false if sorting
		 ...
		 * @return
		 */
		public PropertiesSort withProperties(String... properties) {
			return new PropertiesSort(this.direction, properties);
		}
		...
		/**
		 * Returns a {@link Order} with {@link NullHandling#NATIVE} as null handling
		 * hint.
		 * 
		 * @return
		 * @since 1.7
